...
.qq-upload-fail{
	...
	<div id="profileBox">
						...
						<form class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="input02" placeholder="email@example.com">
							  </div>
							</div>
									 ...
									 <div>
									  ...
									  <div class="thumbnails help-block">
											<a href="#" class="thumbnail span2">
												<div id="profile_image" style="display:none"><img id="profile_thumb"  alt="thumbnail" src="http://placehold.it/160x120" /></div>
											  </a>
									  </div> 
									</div>
							</div>
		...
		<script type="text/javascript">
			...
			function createUploader(element, key){            
				var uploader = new qq.FileUploader({
					element: document.getElementById(element),
					action: 'actions/uploadProfileImage',
					...
					onComplete: function(id, fileName, responseJSON){
						...
						var srcI = "actions/getImage?i=160&id=" + resp;
						$("#profile_thumb").attr("src",srcI);
						$("#profile_image").show();
					},
				});
			}
